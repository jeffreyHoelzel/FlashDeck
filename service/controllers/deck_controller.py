...
from services.deck_services import *
...
def create_deck():
    ...
    # Create a new deck
    new_deck = create_deck_service(data["name"], data["cards"])
...
def edit_deck(deck_id):
    ...
    deck = edit_deck_service(deck_id, name=data["name"], cards=data["cards"])
...
def delete_deck(deck_id):
    error = delete_deck_service(deck_id)
...
def get_all_decks():
    deck_list = get_all_decks_service()
